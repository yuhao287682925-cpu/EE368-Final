...
class TrajectoryErrorElement(genpy.Message):
  _md5sum = "fe19f45de474fe8a7f3de643ea88e472"
...
uint32 waypoint_index"""
  __slots__ = ['error_type','error_identifier','error_value','min_value','max_value','index','message','waypoint_index']
  _slot_types = ['uint32','uint32','float32','float32','float32','uint32','string','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       error_type,error_identifier,error_value,min_value,max_value,index,message,waypoint_index
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.waypoint_index,) = _get_struct_I().unpack(str[start:end])
      return self
