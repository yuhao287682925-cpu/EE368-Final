...
"""autogenerated by genpy from kortex_driver/Waypoint_type_of_waypoint.msg. Do not edit."""
import codecs
import sys
...
class Waypoint_type_of_waypoint(genpy.Message):
  _md5sum = "90682b2ce9c17ef82e25a79e7e035287"
  _type = "kortex_driver/Waypoint_type_of_waypoint"
...
float32 theta_y
float32 theta_z"""
  __slots__ = ['angular_waypoint','cartesian_waypoint']
  _slot_types = ['kortex_driver/AngularWaypoint[]','kortex_driver/CartesianWaypoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       angular_waypoint,cartesian_waypoint
    ...
    """
    if args or kwds:
      super(Waypoint_type_of_waypoint, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.angular_waypoint is None:
        self.angular_waypoint = []
      if self.cartesian_waypoint is None:
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.angular_waypoint)
      buff.write(_struct_I.pack(length))
      for val1 in self.angular_waypoint:
      ...
      length = len(self.cartesian_waypoint)
      buff.write(_struct_I.pack(length))
      for val1 in self.cartesian_waypoint:
        _v1 = val1.pose
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      if self.angular_waypoint is None:
        self.angular_waypoint = None
      if self.cartesian_waypoint is None:
        self.cartesian_waypoint = None
      end = 0
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.angular_waypoint.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.cartesian_waypoint = []
      for i in range(0, length):
        ...
        self.cartesian_waypoint.append(val1)
      return self
