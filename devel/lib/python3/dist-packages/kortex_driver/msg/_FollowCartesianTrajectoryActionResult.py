...
"""autogenerated by genpy from kortex_driver/FollowCartesianTrajectoryActionResult.msg. Do not edit."""
import codecs
import sys
...
class FollowCartesianTrajectoryActionResult(genpy.Message):
  _md5sum = "e5371d194c382360e72c140cd47aaa6c"
  _type = "kortex_driver/FollowCartesianTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kortex_driver/FollowCartesianTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = kortex_driver.msg.FollowCartesianTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kortex_driver.msg.FollowCartesianTrajectoryResult()
