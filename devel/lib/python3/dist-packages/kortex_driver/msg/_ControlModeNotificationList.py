...
"""autogenerated by genpy from kortex_driver/ControlModeNotificationList.msg. Do not edit."""
import codecs
import sys
...
class ControlModeNotificationList(genpy.Message):
  _md5sum = "15ea06dcb7be562d13fce4a4e5f177b9"
  _type = "kortex_driver/ControlModeNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/Base_ControlModeNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ControlModeNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.Base_ControlModeNotification()
        start = end
        end += 4
        (val1.control_mode,) = _get_struct_I().unpack(str[start:end])
        _v5 = val1.timestamp
        _x = _v5
        start = end
        end += 8
