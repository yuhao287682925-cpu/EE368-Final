...
"""autogenerated by genpy from kortex_driver/SequenceTask.msg. Do not edit."""
import codecs
import sys
...
class SequenceTask(genpy.Message):
  _md5sum = "62556b0de19b350f62b6bf54f0910ec7"
  _type = "kortex_driver/SequenceTask"
...
float32 blending_radius"""
  __slots__ = ['group_identifier','action','application_data']
  _slot_types = ['uint32','kortex_driver/Action','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       group_identifier,action,application_data
    ...
    """
    if args or kwds:
      super(SequenceTask, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4I().pack(_x.group_identifier, _x.action.handle.identifier, _x.action.handle.action_type, _x.action.handle.permission))
      _x = self.action.name
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.group_identifier, _x.action.handle.identifier, _x.action.handle.action_type, _x.action.handle.permission,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
