...
class MapElement(genpy.Message):
  _md5sum = "127df689e85b17ce4772c14af9992256"
...
float32 blending_radius"""
      ...
      for val1 in self.action.oneof_action_parameters.execute_waypoint_list:
        ...
        for val2 in val1.waypoints:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _v13 = val2.oneof_type_of_waypoint
          length = len(_v13.angular_waypoint)
          buff.write(_struct_I.pack(length))
          for val4 in _v13.angular_waypoint:
          ...
          buff.write(_struct_I.pack(length))
          for val4 in _v13.cartesian_waypoint:
            _v14 = val4.pose
            _x = _v14
            buff.write(_get_struct_6f().pack(_x.x, _x.y, _x.z, _x.theta_x, _x.theta_y, _x.theta_z))
            _x = val4
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v15 = val1.safety_handle
        start = end
        end += 4
        (_v15.identifier,) = _get_struct_I().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          _v21.joint_angles.append(val3)
        _v22 = val1.constraint
        _x = _v22
        start = end
        end += 8
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          _v27 = val2.oneof_type_of_waypoint
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v27.angular_waypoint = []
          for i in range(0, length):
            ...
            _v27.angular_waypoint.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v27.cartesian_waypoint = []
          for i in range(0, length):
            ...
            _v27.cartesian_waypoint.append(val4)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action.oneof_action_parameters.reach_pose:
        ...
        _v34 = _v33.oneof_type
        length = len(_v34.speed)
        buff.write(_struct_I.pack(length))
        for val4 in _v34.speed:
          _x = val4
          buff.write(_get_struct_2f().pack(_x.translation, _x.orientation))
        length = len(_v34.duration)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(_v34.duration.tostring())
      length = len(self.action.oneof_action_parameters.reach_joint_angles)
      buff.write(_struct_I.pack(length))
      for val1 in self.action.oneof_action_parameters.reach_joint_angles:
        _v35 = val1.joint_angles
        length = len(_v35.joint_angles)
        buff.write(_struct_I.pack(length))
        for val3 in _v35.joint_angles:
          _x = val3
          buff.write(_get_struct_If().pack(_x.joint_identifier, _x.value))
        _v36 = val1.constraint
        _x = _v36
        buff.write(_get_struct_If().pack(_x.type, _x.value))
      length = len(self.action.oneof_action_parameters.toggle_admittance_mode)
      buff.write(_struct_I.pack(length))
      ...
      for val1 in self.action.oneof_action_parameters.switch_control_mapping:
        _x = val1.controller_identifier
        buff.write(_get_struct_I().pack(_x))
        _v37 = val1.map_group_handle
        _x = _v37
        buff.write(_get_struct_2I().pack(_x.identifier, _x.permission))
        _v38 = val1.map_handle
        _x = _v38
        buff.write(_get_struct_2I().pack(_x.identifier, _x.permission))
      length = len(self.action.oneof_action_parameters.navigate_joints)
      buff.write(_struct_I.pack(length))
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action.oneof_action_parameters.change_joint_speeds:
        _v39 = val1.joint_speeds
        length = len(_v39.joint_speeds)
        buff.write(_struct_I.pack(length))
        for val3 in _v39.joint_speeds:
          _x = val3
          buff.write(_get_struct_IfI().pack(_x.joint_identifier, _x.value, _x.duration))
        _x = _v39.duration
        buff.write(_get_struct_I().pack(_x))
      ...
      for val1 in self.action.oneof_action_parameters.send_gripper_command:
        ...
        buff.write(_get_struct_I().pack(_x))
        _v40 = val1.gripper
        length = len(_v40.finger)
        buff.write(_struct_I.pack(length))
        for val3 in _v40.finger:
          _x = val3
          buff.write(_get_struct_If().pack(_x.finger_identifier, _x.value))
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      ...
      for val1 in self.action.oneof_action_parameters.execute_waypoint_list:
        ...
        for val2 in val1.waypoints:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _v41 = val2.oneof_type_of_waypoint
          length = len(_v41.angular_waypoint)
          buff.write(_struct_I.pack(length))
          for val4 in _v41.angular_waypoint:
            length = len(val4.angles)
            buff.write(_struct_I.pack(length))
            pattern = '<%sf'%length
            ...
            _x = val4.duration
            buff.write(_get_struct_f().pack(_x))
          length = len(_v41.cartesian_waypoint)
          buff.write(_struct_I.pack(length))
          for val4 in _v41.cartesian_waypoint:
            _v42 = val4.pose
            _x = _v42
            buff.write(_get_struct_6f().pack(_x.x, _x.y, _x.z, _x.theta_x, _x.theta_y, _x.theta_z))
            _x = val4
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.SafetyEvent()
        _v43 = val1.safety_handle
        start = end
        end += 4
        (_v43.identifier,) = _get_struct_I().unpack(str[start:end])
        self.event.oneof_events.safety_event.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        _v48.duration = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
        self.action.oneof_action_parameters.reach_pose.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.joint_identifier, _x.value,) = _get_struct_If().unpack(str[start:end])
          _v49.joint_angles.append(val3)
        _v50 = val1.constraint
        _x = _v50
        start = end
        end += 8
        (_x.type, _x.value,) = _get_struct_If().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (val1.controller_identifier,) = _get_struct_I().unpack(str[start:end])
        _v51 = val1.map_group_handle
        _x = _v51
        start = end
        end += 8
        (_x.identifier, _x.permission,) = _get_struct_2I().unpack(str[start:end])
        _v52 = val1.map_handle
        _x = _v52
        start = end
        end += 8
        (_x.identifier, _x.permission,) = _get_struct_2I().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.joint_identifier, _x.value, _x.duration,) = _get_struct_IfI().unpack(str[start:end])
          _v53.joint_speeds.append(val3)
        start = end
        end += 4
        (_v53.duration,) = _get_struct_I().unpack(str[start:end])
        self.action.oneof_action_parameters.change_joint_speeds.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2.name = str[start:end]
          _v55 = val2.oneof_type_of_waypoint
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v55.angular_waypoint = []
          for i in range(0, length):
            val4 = kortex_driver.msg.AngularWaypoint()
            start = end
            end += 4
            ...
            (val4.duration,) = _get_struct_f().unpack(str[start:end])
            _v55.angular_waypoint.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v55.cartesian_waypoint = []
          for i in range(0, length):
            val4 = kortex_driver.msg.CartesianWaypoint()
            _v56 = val4.pose
            _x = _v56
            ...
            (_x.reference_frame, _x.maximum_linear_velocity, _x.maximum_angular_velocity, _x.blending_radius,) = _get_struct_I3f().unpack(str[start:end])
            _v55.cartesian_waypoint.append(val4)
          val1.waypoints.append(val2)
        _x = val1
        start = end
        end += 5
