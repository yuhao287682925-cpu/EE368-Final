...
"""autogenerated by genpy from kortex_driver/Action_action_parameters.msg. Do not edit."""
import codecs
import sys
...
class Action_action_parameters(genpy.Message):
  _md5sum = "3d6115bf166bbc775637a0580d1e6e6c"
  _type = "kortex_driver/Action_action_parameters"
...
float32 blending_radius"""
  __slots__ = ['send_twist_command','send_wrench_command','send_joint_speeds','reach_pose','reach_joint_angles','toggle_admittance_mode','snapshot','switch_control_mapping','navigate_joints','navigate_mappings','change_twist','change_joint_speeds','change_wrench','apply_emergency_stop','clear_faults','delay','execute_action','send_gripper_command','send_gpio_command','stop_action','play_pre_computed_trajectory','execute_sequence','execute_waypoint_list']
  _slot_types = ['kortex_driver/TwistCommand[]','kortex_driver/WrenchCommand[]','kortex_driver/Base_JointSpeeds[]','kortex_driver/ConstrainedPose[]','kortex_driver/ConstrainedJointAngles[]','uint32[]','kortex_driver/Snapshot[]','kortex_driver/SwitchControlMapping[]','uint32[]','uint32[]','kortex_driver/ChangeTwist[]','kortex_driver/ChangeJointSpeeds[]','kortex_driver/ChangeWrench[]','kortex_driver/EmergencyStop[]','kortex_driver/Faults[]','kortex_driver/Delay[]','kortex_driver/ActionHandle[]','kortex_driver/GripperCommand[]','kortex_driver/GpioCommand[]','kortex_driver/Base_Stop[]','kortex_driver/PreComputedJointTrajectory[]','kortex_driver/SequenceHandle[]','kortex_driver/WaypointList[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       send_twist_command,send_wrench_command,send_joint_speeds,reach_pose,reach_joint_angles,toggle_admittance_mode,snapshot,switch_control_mapping,navigate_joints,navigate_mappings,change_twist,change_joint_speeds,change_wrench,apply_emergency_stop,clear_faults,delay,execute_action,send_gripper_command,send_gpio_command,stop_action,play_pre_computed_trajectory,execute_sequence,execute_waypoint_list
    ...
    """
    if args or kwds:
      super(Action_action_parameters, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.send_twist_command is None:
        self.send_twist_command = []
      if self.send_wrench_command is None:
        self.send_wrench_command = []
      if self.send_joint_speeds is None:
        self.send_joint_speeds = []
      if self.reach_pose is None:
        self.reach_pose = []
      if self.reach_joint_angles is None:
        self.reach_joint_angles = []
      if self.toggle_admittance_mode is None:
        self.toggle_admittance_mode = []
      if self.snapshot is None:
        self.snapshot = []
      if self.switch_control_mapping is None:
        self.switch_control_mapping = []
      if self.navigate_joints is None:
        self.navigate_joints = []
      if self.navigate_mappings is None:
        self.navigate_mappings = []
      if self.change_twist is None:
        self.change_twist = []
      if self.change_joint_speeds is None:
        self.change_joint_speeds = []
      if self.change_wrench is None:
        self.change_wrench = []
      if self.apply_emergency_stop is None:
      ...
      if self.send_gpio_command is None:
        self.send_gpio_command = []
      if self.stop_action is None:
        self.stop_action = []
      if self.play_pre_computed_trajectory is None:
        self.play_pre_computed_trajectory = []
      if self.execute_sequence is None:
        self.execute_sequence = []
      if self.execute_waypoint_list is None:
        self.execute_waypoint_list = []
    else:
      self.send_twist_command = []
      self.send_wrench_command = []
      self.send_joint_speeds = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.send_twist_command)
      buff.write(_struct_I.pack(length))
      for val1 in self.send_twist_command:
        ...
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.send_wrench_command)
      buff.write(_struct_I.pack(length))
      for val1 in self.send_wrench_command:
        _x = val1
        ...
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.send_joint_speeds)
      buff.write(_struct_I.pack(length))
      for val1 in self.send_joint_speeds:
        ...
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.reach_pose)
      buff.write(_struct_I.pack(length))
      for val1 in self.reach_pose:
      ...
      length = len(self.reach_joint_angles)
      buff.write(_struct_I.pack(length))
      for val1 in self.reach_joint_angles:
      ...
      length = len(self.toggle_admittance_mode)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.toggle_admittance_mode))
      length = len(self.snapshot)
      buff.write(_struct_I.pack(length))
      for val1 in self.snapshot:
        _x = val1.snapshot_type
        buff.write(_get_struct_I().pack(_x))
      length = len(self.switch_control_mapping)
      buff.write(_struct_I.pack(length))
      for val1 in self.switch_control_mapping:
        ...
        _x = _v9
        buff.write(_get_struct_2I().pack(_x.identifier, _x.permission))
      length = len(self.navigate_joints)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.navigate_joints))
      length = len(self.navigate_mappings)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.navigate_mappings))
      length = len(self.change_twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.change_twist:
        _x = val1
        buff.write(_get_struct_2f().pack(_x.linear, _x.angular))
      length = len(self.change_joint_speeds)
      buff.write(_struct_I.pack(length))
      for val1 in self.change_joint_speeds:
        ...
        _x = _v10.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.change_wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.change_wrench:
        _x = val1
        buff.write(_get_struct_2f().pack(_x.force, _x.torque))
      length = len(self.apply_emergency_stop)
      buff.write(_struct_I.pack(length))
      for val1 in self.apply_emergency_stop:
        pass
      length = len(self.clear_faults)
      buff.write(_struct_I.pack(length))
      for val1 in self.clear_faults:
        pass
      length = len(self.delay)
      buff.write(_struct_I.pack(length))
      for val1 in self.delay:
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.execute_action)
      buff.write(_struct_I.pack(length))
      for val1 in self.execute_action:
        _x = val1
        buff.write(_get_struct_3I().pack(_x.identifier, _x.action_type, _x.permission))
      length = len(self.send_gripper_command)
      buff.write(_struct_I.pack(length))
      for val1 in self.send_gripper_command:
        _x = val1.mode
        buff.write(_get_struct_I().pack(_x))
        _v11 = val1.gripper
        ...
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.send_gpio_command)
      buff.write(_struct_I.pack(length))
      for val1 in self.send_gpio_command:
        _x = val1
        buff.write(_get_struct_4I().pack(_x.port_identifier, _x.pin_identifier, _x.action, _x.period))
      length = len(self.stop_action)
      buff.write(_struct_I.pack(length))
      for val1 in self.stop_action:
        pass
      length = len(self.play_pre_computed_trajectory)
      buff.write(_struct_I.pack(length))
      for val1 in self.play_pre_computed_trajectory:
        _x = val1.mode
        buff.write(_get_struct_I().pack(_x))
      ...
      length = len(self.execute_sequence)
      buff.write(_struct_I.pack(length))
      for val1 in self.execute_sequence:
        _x = val1
        buff.write(_get_struct_2I().pack(_x.identifier, _x.permission))
      length = len(self.execute_waypoint_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.execute_waypoint_list:
  ...
  def deserialize(self, str):
    ...
    try:
      if self.send_twist_command is None:
        self.send_twist_command = None
      if self.send_wrench_command is None:
        self.send_wrench_command = None
      if self.send_joint_speeds is None:
        self.send_joint_speeds = None
      if self.reach_pose is None:
        self.reach_pose = None
      if self.reach_joint_angles is None:
        self.reach_joint_angles = None
      if self.snapshot is None:
        self.snapshot = None
      if self.switch_control_mapping is None:
        self.switch_control_mapping = None
      if self.change_twist is None:
        self.change_twist = None
      if self.change_joint_speeds is None:
        self.change_joint_speeds = None
      if self.change_wrench is None:
        self.change_wrench = None
      if self.apply_emergency_stop is None:
        self.apply_emergency_stop = None
      if self.clear_faults is None:
        self.clear_faults = None
      if self.delay is None:
        self.delay = None
      if self.execute_action is None:
      ...
      if self.send_gpio_command is None:
        self.send_gpio_command = None
      if self.stop_action is None:
        self.stop_action = None
      if self.play_pre_computed_trajectory is None:
        self.play_pre_computed_trajectory = None
      if self.execute_sequence is None:
        self.execute_sequence = None
      if self.execute_waypoint_list is None:
        self.execute_waypoint_list = None
      end = 0
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.send_twist_command.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.send_wrench_command = []
      for i in range(0, length):
        ...
        (val1.duration,) = _get_struct_I().unpack(str[start:end])
        self.send_wrench_command.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.send_joint_speeds = []
      for i in range(0, length):
        ...
        (val1.duration,) = _get_struct_I().unpack(str[start:end])
        self.send_joint_speeds.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.reach_pose = []
      ...
      for i in range(0, length):
        ...
        self.reach_joint_angles.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.toggle_admittance_mode = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.snapshot = []
      ...
      for i in range(0, length):
        ...
        (_x.identifier, _x.permission,) = _get_struct_2I().unpack(str[start:end])
        self.switch_control_mapping.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.navigate_joints = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.navigate_mappings = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.change_twist = []
      ...
      for i in range(0, length):
        ...
        self.change_joint_speeds.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.change_wrench = []
      for i in range(0, length):
        ...
        self.change_wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.apply_emergency_stop = []
      for i in range(0, length):
        ...
        self.apply_emergency_stop.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.clear_faults = []
      ...
      for i in range(0, length):
        ...
        self.execute_action.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.send_gripper_command = []
      for i in range(0, length):
        ...
        (val1.duration,) = _get_struct_I().unpack(str[start:end])
        self.send_gripper_command.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.send_gpio_command = []
      for i in range(0, length):
        ...
        self.send_gpio_command.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.stop_action = []
      ...
      for i in range(0, length):
        ...
        self.play_pre_computed_trajectory.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.execute_sequence = []
      for i in range(0, length):
        ...
        (_x.identifier, _x.permission,) = _get_struct_2I().unpack(str[start:end])
        self.execute_sequence.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.execute_waypoint_list = []
      for i in range(0, length):
        ...
        self.execute_waypoint_list.append(val1)
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(self.toggle_admittance_mode.tostring())
      length = len(self.snapshot)
      buff.write(_struct_I.pack(length))
      for val1 in self.snapshot:
        _x = val1.snapshot_type
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(self.navigate_joints.tostring())
      length = len(self.navigate_mappings)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(self.navigate_mappings.tostring())
      length = len(self.change_twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.change_twist:
        _x = val1
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.toggle_admittance_mode = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.snapshot = []
      ...
      self.navigate_joints = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.navigate_mappings = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.change_twist = []
