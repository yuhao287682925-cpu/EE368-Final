...
"""autogenerated by genpy from kortex_driver/Map.msg. Do not edit."""
import codecs
import sys
...
class Map(genpy.Message):
  _md5sum = "7ba3126177fdde6cbeb4135ed4c8abdc"
  _type = "kortex_driver/Map"
...
float32 blending_radius"""
  __slots__ = ['handle','name','elements']
  _slot_types = ['kortex_driver/MapHandle','string','kortex_driver/MapElement[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.handle is None:
        self.handle = kortex_driver.msg.MapHandle()
