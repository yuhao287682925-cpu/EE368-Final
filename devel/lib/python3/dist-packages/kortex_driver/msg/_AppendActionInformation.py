...
"""autogenerated by genpy from kortex_driver/AppendActionInformation.msg. Do not edit."""
import codecs
import sys
...
class AppendActionInformation(genpy.Message):
  _md5sum = "93054e31299322677194952ad0f3b05e"
  _type = "kortex_driver/AppendActionInformation"
...
float32 blending_radius"""
  __slots__ = ['sequence_handle','action']
  _slot_types = ['kortex_driver/SequenceHandle','kortex_driver/Action']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AppendActionInformation, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5I().pack(_x.sequence_handle.identifier, _x.sequence_handle.permission, _x.action.handle.identifier, _x.action.handle.action_type, _x.action.handle.permission))
      _x = self.action.name
      length = len(_x)
      ...
      for val1 in self.action.oneof_action_parameters.send_gripper_command:
        ...
        _x = val1.duration
        buff.write(_get_struct_I().pack(_x))
      length = len(self.action.oneof_action_parameters.send_gpio_command)
      buff.write(_struct_I.pack(length))
      for val1 in self.action.oneof_action_parameters.send_gpio_command:
        _x = val1
      ...
      length = len(self.action.oneof_action_parameters.execute_sequence)
      buff.write(_struct_I.pack(length))
      for val1 in self.action.oneof_action_parameters.execute_sequence:
        _x = val1
        buff.write(_get_struct_2I().pack(_x.identifier, _x.permission))
      length = len(self.action.oneof_action_parameters.execute_waypoint_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.action.oneof_action_parameters.execute_waypoint_list:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sequence_handle.identifier, _x.sequence_handle.permission, _x.action.handle.identifier, _x.action.handle.action_type, _x.action.handle.permission,) = _get_struct_5I().unpack(str[start:end])
      start = end
      end += 4
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action.oneof_action_parameters.send_gpio_command = []
      for i in range(0, length):
        ...
        self.action.oneof_action_parameters.send_gpio_command.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action.oneof_action_parameters.execute_sequence = []
      for i in range(0, length):
        ...
        (_x.identifier, _x.permission,) = _get_struct_2I().unpack(str[start:end])
        self.action.oneof_action_parameters.execute_sequence.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action.oneof_action_parameters.execute_waypoint_list = []
      for i in range(0, length):
        ...
        self.action.oneof_action_parameters.execute_waypoint_list.append(val1)
      return self
