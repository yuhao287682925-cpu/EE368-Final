...
"""autogenerated by genpy from kortex_driver/WaypointValidationReport.msg. Do not edit."""
import codecs
import sys
...
class WaypointValidationReport(genpy.Message):
  _md5sum = "a7dd565ec93d4c9c5950e62db23f8114"
  _type = "kortex_driver/WaypointValidationReport"
...
float32 theta_y
float32 theta_z"""
  __slots__ = ['trajectory_error_report','optimal_waypoint_list']
  _slot_types = ['kortex_driver/TrajectoryErrorReport','kortex_driver/WaypointList']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory_error_report,optimal_waypoint_list
    ...
    """
    if args or kwds:
      super(WaypointValidationReport, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.trajectory_error_report is None:
        self.trajectory_error_report = kortex_driver.msg.TrajectoryErrorReport()
      if self.optimal_waypoint_list is None:
        self.optimal_waypoint_list = kortex_driver.msg.WaypointList()
    else:
      self.trajectory_error_report = kortex_driver.msg.TrajectoryErrorReport()
      self.optimal_waypoint_list = kortex_driver.msg.WaypointList()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.trajectory_error_report.trajectory_error_elements)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory_error_report.trajectory_error_elements:
        _x = val1
      ...
      length = len(self.optimal_waypoint_list.waypoints)
      buff.write(_struct_I.pack(length))
      for val1 in self.optimal_waypoint_list.waypoints:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_fB().pack(_x.optimal_waypoint_list.duration, _x.optimal_waypoint_list.use_optimal_blending))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.trajectory_error_report.trajectory_error_elements = []
      for i in range(0, length):
        ...
        self.trajectory_error_report.trajectory_error_elements.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.optimal_waypoint_list.waypoints = []
      for i in range(0, length):
        ...
        self.optimal_waypoint_list.waypoints.append(val1)
      _x = self
      start = end
      end += 5
      (_x.optimal_waypoint_list.duration, _x.optimal_waypoint_list.use_optimal_blending,) = _get_struct_fB().unpack(str[start:end])
      self.optimal_waypoint_list.use_optimal_blending = bool(self.optimal_waypoint_list.use_optimal_blending)
      return self
