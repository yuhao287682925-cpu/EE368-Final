...
"""autogenerated by genpy from kortex_driver/SequenceList.msg. Do not edit."""
import codecs
import sys
...
class SequenceList(genpy.Message):
  _md5sum = "a3e8f4d640296bb71ee2c53766619708"
  _type = "kortex_driver/SequenceList"
...
float32 blending_radius"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SequenceList, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.sequence_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.sequence_list:
        _v1 = val1.handle
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.sequence_list.append(val1)
      return self
