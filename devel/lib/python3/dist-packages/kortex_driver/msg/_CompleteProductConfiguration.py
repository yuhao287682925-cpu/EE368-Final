...
class CompleteProductConfiguration(genpy.Message):
  _md5sum = "b73bc25bff314a65c4c98c0970043ccf"
...
uint32 identifier"""
  __slots__ = ['kin','model','country_code','assembly_plant','model_year','degree_of_freedom','base_type','end_effector_type','vision_module_type','interface_module_type','arm_laterality','wrist_type','brake_type']
  _slot_types = ['string','uint32','kortex_driver/CountryCode','string','string','uint32','uint32','uint32','uint32','uint32','uint32','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       kin,model,country_code,assembly_plant,model_year,degree_of_freedom,base_type,end_effector_type,vision_module_type,interface_module_type,arm_laterality,wrist_type,brake_type
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_8I().pack(_x.degree_of_freedom, _x.base_type, _x.end_effector_type, _x.vision_module_type, _x.interface_module_type, _x.arm_laterality, _x.wrist_type, _x.brake_type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.degree_of_freedom, _x.base_type, _x.end_effector_type, _x.vision_module_type, _x.interface_module_type, _x.arm_laterality, _x.wrist_type, _x.brake_type,) = _get_struct_8I().unpack(str[start:end])
      return self
