...
(cl:defclass <SubErrorCodes> (roslisp-msg-protocol:ros-message)
  ()
)

(cl:defclass SubErrorCodes (<SubErrorCodes>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SubErrorCodes>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SubErrorCodes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<SubErrorCodes> is deprecated: use kortex_driver-msg:SubErrorCodes instead.")))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<SubErrorCodes>)))
    "Constants for message type '<SubErrorCodes>"
  '((:SUB_ERROR_NONE . 0)
    (:METHOD_FAILED . 1)
    (:UNIMPLEMENTED . 2)
    (:INVALID_PARAM . 3)
