...
(cl:defclass <Action> (roslisp-msg-protocol:ros-message)
  ((handle
   ...
   (oneof_action_parameters
    ...
    :type kortex_driver-msg:Action_action_parameters
    :initform (cl:make-instance 'kortex_driver-msg:Action_action_parameters)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<Action> is deprecated: use kortex_driver-msg:Action instead.")))

(cl:ensure-generic-function 'handle-val :lambda-list '(m))
(cl:defmethod handle-val ((m <Action>))
...
(cl:defmethod application_data-val ((m <Action>))
...
(cl:defmethod oneof_action_parameters-val ((m <Action>))
