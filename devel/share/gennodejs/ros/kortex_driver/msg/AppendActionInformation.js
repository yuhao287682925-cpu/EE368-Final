...
class AppendActionInformation {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AppendActionInformation
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AppendActionInformation
    let len;
    let data = new AppendActionInformation(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AppendActionInformation(null);
...
module.exports = AppendActionInformation;
