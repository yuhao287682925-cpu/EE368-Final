...
class Base_ControlModeNotification {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Base_ControlModeNotification(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Base_ControlModeNotification(null);
...
module.exports = Base_ControlModeNotification;
