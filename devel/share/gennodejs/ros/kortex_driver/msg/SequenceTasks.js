...
class SequenceTasks {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SequenceTasks
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SequenceTasks
    let len;
    let data = new SequenceTasks(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SequenceTasks(null);
