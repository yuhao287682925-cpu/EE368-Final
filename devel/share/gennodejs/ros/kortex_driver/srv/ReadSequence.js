...
class ReadSequenceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReadSequenceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReadSequenceRequest
    let len;
    let data = new ReadSequenceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReadSequenceRequest(null);
...
class ReadSequenceResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReadSequenceResponse
    // Serialize message field [output]
    bufferOffset = Sequence.serialize(obj.output, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReadSequenceResponse
    let len;
    let data = new ReadSequenceResponse(null);
    // Deserialize message field [output]
    data.output = Sequence.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Sequence.getMessageSize(object.output);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReadSequenceResponse(null);
    if (msg.output !== undefined) {
      resolved.output = Sequence.Resolve(msg.output)
    }
    else {
      resolved.output = new Sequence()
    }
...
module.exports = {
  ...
  md5sum() { return '55d98eff8277cc35278db3a1d82f673c'; },
  datatype() { return 'kortex_driver/ReadSequence'; }
};
