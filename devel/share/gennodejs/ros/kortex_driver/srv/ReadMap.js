...
class ReadMapRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReadMapRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReadMapRequest
    let len;
    let data = new ReadMapRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReadMapRequest(null);
...
class ReadMapResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReadMapResponse
    // Serialize message field [output]
    bufferOffset = Map.serialize(obj.output, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReadMapResponse
    let len;
    let data = new ReadMapResponse(null);
    // Deserialize message field [output]
    data.output = Map.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Map.getMessageSize(object.output);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReadMapResponse(null);
    if (msg.output !== undefined) {
      resolved.output = Map.Resolve(msg.output)
    }
    else {
      resolved.output = new Map()
    }
...
module.exports = {
  ...
  Response: ReadMapResponse,
  md5sum() { return '534e7bca73ccd0ef48c895273ca3dd63'; },
  datatype() { return 'kortex_driver/ReadMap'; }
};
