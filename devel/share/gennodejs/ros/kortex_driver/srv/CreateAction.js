...
class CreateActionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CreateActionRequest
    // Serialize message field [input]
    bufferOffset = Action.serialize(obj.input, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CreateActionRequest
    let len;
    let data = new CreateActionRequest(null);
    // Deserialize message field [input]
    data.input = Action.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Action.getMessageSize(object.input);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CreateActionRequest(null);
    if (msg.input !== undefined) {
      resolved.input = Action.Resolve(msg.input)
    }
    else {
      resolved.input = new Action()
    }
...
class CreateActionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('output')) {
        ...
        this.output = new ActionHandle();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CreateActionResponse
    // Serialize message field [output]
    bufferOffset = ActionHandle.serialize(obj.output, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CreateActionResponse
    let len;
    let data = new CreateActionResponse(null);
    // Deserialize message field [output]
    data.output = ActionHandle.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CreateActionResponse(null);
    if (msg.output !== undefined) {
      resolved.output = ActionHandle.Resolve(msg.output)
    }
    else {
      resolved.output = new ActionHandle()
    }
...
module.exports = {
  ...
  md5sum() { return 'daceef3526eb3a84b9c2d90779f124c8'; },
  datatype() { return 'kortex_driver/CreateAction'; }
};
