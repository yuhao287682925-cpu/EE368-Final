...
class UpdateSequenceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UpdateSequenceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UpdateSequenceRequest
    let len;
    let data = new UpdateSequenceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdateSequenceRequest(null);
...
class UpdateSequenceResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UpdateSequenceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UpdateSequenceResponse
    let len;
    let data = new UpdateSequenceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdateSequenceResponse(null);
...
module.exports = {
  ...
  md5sum() { return '42cb8fcf59e13a93c2ae4b3f1a8f8519'; },
  datatype() { return 'kortex_driver/UpdateSequence'; }
};
