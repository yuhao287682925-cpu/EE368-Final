...
class SetGPIOConfigurationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('input')) {
        ...
        this.input = new InterconnectConfig_GPIOConfiguration();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = InterconnectConfig_GPIOConfiguration.serialize(obj.input, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.input = InterconnectConfig_GPIOConfiguration.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static messageDefinition() {
    ...
    return `
    InterconnectConfig_GPIOConfiguration input
  ...
  static Resolve(msg) {
    ...
    if (msg.input !== undefined) {
      resolved.input = InterconnectConfig_GPIOConfiguration.Resolve(msg.input)
    }
    else {
      resolved.input = new InterconnectConfig_GPIOConfiguration()
    }
