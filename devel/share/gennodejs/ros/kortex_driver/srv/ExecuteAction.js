...
class ExecuteActionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ExecuteActionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ExecuteActionRequest
    let len;
    let data = new ExecuteActionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteActionRequest(null);
...
class ExecuteActionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ExecuteActionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ExecuteActionResponse
    let len;
    let data = new ExecuteActionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteActionResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'b3a49d29f09f642d40439aa331b5b44c'; },
  datatype() { return 'kortex_driver/ExecuteAction'; }
};
