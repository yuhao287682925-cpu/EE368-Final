...
class UpdateActionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UpdateActionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UpdateActionRequest
    let len;
    let data = new UpdateActionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdateActionRequest(null);
...
class UpdateActionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UpdateActionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UpdateActionResponse
    let len;
    let data = new UpdateActionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdateActionResponse(null);
...
module.exports = {
  ...
  datatype() { return 'kortex_driver/UpdateAction'; }
};
