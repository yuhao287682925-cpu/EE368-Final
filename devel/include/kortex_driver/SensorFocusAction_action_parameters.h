...
struct Printer< ::kortex_driver::SensorFocusAction_action_parameters_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::SensorFocusAction_action_parameters_<ContainerAllocator>& v)
  {
    if (false || !indent.empty())
      s << std::endl;
    s << indent << "focus_point: ";
    if (v.focus_point.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.focus_point.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::kortex_driver::FocusPoint_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.focus_point[i]);
    }
    if (v.focus_point.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "manual_focus: ";
    if (v.manual_focus.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.manual_focus.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::kortex_driver::ManualFocus_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.manual_focus[i]);
    }
    if (v.manual_focus.empty() || false)
      s << "]";
  }
