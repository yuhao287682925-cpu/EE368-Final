...
#endif
#if defined(_WIN32) && defined(BRAKE_REMOVAL_FAILURE)
  #undef BRAKE_REMOVAL_FAILURE
#endif
...
struct MD5Sum< ::kortex_driver::Base_SafetyIdentifier_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x1af24619c0f6e3d6ULL;
  static const uint64_t static_value2 = 0x1a2eb98a96e27e96ULL;
};
