...
struct Printer< ::kortex_driver::ControllerNotification_state_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::ControllerNotification_state_<ContainerAllocator>& v)
  {
    ...
    if (v.controller_state.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.controller_state.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::kortex_driver::ControllerState_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.controller_state[i]);
    }
    if (v.controller_state.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "controller_element: ";
    if (v.controller_element.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.controller_element.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::kortex_driver::ControllerElementState_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.controller_element[i]);
    }
    if (v.controller_element.empty() || false)
      s << "]";
  }
