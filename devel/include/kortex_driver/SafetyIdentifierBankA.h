...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(BRAKE_DRIVE_FAULT)
  #undef BRAKE_DRIVE_FAULT
#endif
#if defined(_WIN32) && defined(BRAKE_RELEASE_MOTION_OUT_OF_RANGE)
  #undef BRAKE_RELEASE_MOTION_OUT_OF_RANGE
#endif
  ...
  enum {
    ...
    BRAKE_DRIVE_FAULT = 134217728u,
    BRAKE_RELEASE_MOTION_OUT_OF_RANGE = 268435456u,
  };
...
struct MD5Sum< ::kortex_driver::SafetyIdentifierBankA_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe8cfb814cd11bbacULL;
  static const uint64_t static_value2 = 0xd2f40df395053aa0ULL;
};
