...
#endif
#if defined(_WIN32) && defined(ARMSTATE_BRAKE_RELEASING)
  #undef ARMSTATE_BRAKE_RELEASING
#endif
...
struct MD5Sum< ::kortex_driver::ArmState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xac681740837f1665ULL;
  static const uint64_t static_value2 = 0x18d3ae6a4e6eeda1ULL;
};
